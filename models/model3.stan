...
model {
  // priors
  b0_mu ~ normal(0.0, 2.0);
  to_vector(b1_mu) ~ normal(0.0, 2.0);
  g0_mu ~ normal(0.0, 2.0);
  to_vector(g1_mu) ~ normal(0.0, 1.0);
...
generated quantities {
  ...
  //Have to rerun calcs to get test LL
    real gamma[N, T, K];
  matrix[K, K] A0;
  matrix[K, K] A;
